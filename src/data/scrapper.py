...
class Scrapper:
    ...
    def start(self):
        ...
        self.logger.info(f'Start data scrapping from {self.source_name if self.source_name else self.base_url}')
...
class BikeWaleScrapper(Scrapper):
    ...
    def extract(self, url):
        ...
        for bike in bike_list:
            ...
            self.save(model_name,model_year,kms_driven,owner,location,price)
...
class CarAndBikeScrapper(Scrapper):
    ...
    def extract(self, html_document):
        ...
        bike_list = soup.find('div', class_='clist__main').find_all('div',class_='usedcar-widget')
        ...
        for bike in bike_list:
            ...
            kms_owner_info = bike.find('ul',class_='usedcar-widget__infolist').find_all('li')
...
class Bikes24Scrapper(Scrapper):
    ...
    def extract(self, html_document):
        ...
        for bike in bike_list:
            ...
            if model_name_ele:
                model_name = model_name_ele.text
            # model_year = None
    ...
    def start(self):
        ...
        time.sleep(3)
        first_popup = self.driver.find_element_by_xpath('/html/body/div[1]/div/div[1]/div[2]/div/div/h3/div/img')
        
        first_popup.click()

        time.sleep(2)

        bike_list = self.driver.find_element_by_xpath('/html/body/div[1]/div/div[2]/div/div[2]/div[2]/div[2]/div').get_attribute('innerHTML')
